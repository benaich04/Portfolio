      ...
      },      
    {
...

      {
        ...
        media: [
          ...
          { type: 'image', src: '/images/experience/Room_labelling_4.png', alt: 'Reconstructed operator’s trajectory (in red) superimposed to the point cloud (ceiling has been removed for visualization purposes)' },
          { type: 'image', src: '/images/experience/Room_labelling_6.png', alt: 'Projected point cloud (in blue) and trajectory (in red) aligned with the simplified floor plan (in black)' }
        ],
        publication: {
        ...
        images: [
          { src: '/images/experience/Room_labelling_4.png', alt: 'Construction robot overview' }
        ]
      },
  ];
